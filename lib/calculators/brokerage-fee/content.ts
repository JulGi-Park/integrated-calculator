...
export const brokerageFeeFaqs: BrokerageFeeFaq[] = [
  {
    ...
    answer:
      "주택의 매매·교환, 전세, 월세 중개보수 상한액을 계산합니다. 상가, 토지, 분양권, 주택 요건을 충족하지 않는 오피스텔은 계산 범위에서 제외합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "오피스텔은 전용면적과 주거 설비 등 법령상 요건에 따라 별도 요율이 적용될 수 있습니다. 이 계산기는 주택 매매·전세·월세에 한정합니다.",
  },
  {
