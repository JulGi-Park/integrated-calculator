...
function isOvertimePayCalculatorEnabled(): boolean {
  return process.env.NEXT_PUBLIC_ENABLE_OVERTIME_PAY_CALCULATOR === "true";
}

export default function OvertimePayPage() {
  if (!isOvertimePayCalculatorEnabled()) {
    notFound();
  }
