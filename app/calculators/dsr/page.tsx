...
import { isDsrCalculatorEnabled } from "@/lib/calculators/dsr";

const title = "DSR 계산기 2026 - 스트레스 DSR 반영 대출한도 계산";
const description =
  "연소득, 기존 대출, 신규 대출 조건, 스트레스 금리를 입력해 예상 DSR 비율과 대출 가능성을 참고용으로 확인합니다.";
