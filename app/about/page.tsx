  ...
  return (
    ...
    >
      <section>
        <h2>서비스 목적</h2>
        <p>
          계산박스(gyesanbox)는 gyesanbox.kr에서 일상과 업무에 자주 필요한
          계산을 한곳에서 빠르게 살펴볼 수 있도록 제공하는 온라인 계산기
          모음입니다. 사용자가 숫자를 입력하면 결과만 던져주는 화면이 아니라,
          어떤 입력값이 필요한지와 어떤 기준으로 계산되는지를 함께 확인할 수
          있도록 운영합니다.
        </p>
      </section>
