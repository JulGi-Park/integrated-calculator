...
const baseUpdates = [
  ...
  },
  {
    ...
    change: "ROAS, 예금·적금, 물타기·평단가, 카드 할부, 부동산 중개보수, 자동차 유지비, 연장·야간·휴일근로수당, 청년미래적금, DSR, 근로·자녀장려금 계산기를 공개해 당시 제공 계산기를 총 20개로 확대했습니다.",
    reason: "생활·금융·근로·사업·주거 영역에서 자주 찾는 계산을 공개 계산기 목록과 사이트맵에서 바로 이용할 수 있도록 공개 범위를 확장했습니다.",
    evidence: "해당 공개 시점의 계산기 목록과 각 페이지에서 20개 계산기의 입력·결과·기준 설명을 확인했습니다. 이후 국비지원 자격증 취득비용 계산기가 추가되어 현재 공개 수는 21개입니다.",
    href: "/calculators/",
  },
  {
    date: "2026년 8월 9일",
