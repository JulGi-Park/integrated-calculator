...
const updates = [
  {
    date: "2026년 8월 11일",
    target: "공개 계산기 공유 대표 이미지",
    change: "공개 계산기 20개에 계산기별 대표 이미지를 적용해 링크를 공유할 때 계산기 주제에 맞는 이미지가 표시되도록 개선했습니다.",
    reason: "계산기 링크를 SNS와 메신저로 공유할 때 어떤 계산기인지 한눈에 확인할 수 있도록 하기 위해서입니다.",
    evidence: "현재 공개 계산기 20개 페이지의 공유 정보와 계산기별 대표 이미지가 연결된 상태를 확인할 수 있습니다.",
    href: "/calculators/",
  },
  {
    date: "2026년 8월 9일",
