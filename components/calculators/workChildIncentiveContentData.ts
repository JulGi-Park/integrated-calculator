...
export const workChildIncentiveCriteria = [
  ...
  },
  {
    title: "예상 산정 방식",
    description:
      "국세청 실제 산정표와 심사 자료를 대체하지 않도록 최대 지급액, 소득 기준, 재산 감액을 반영한 예상액과 예상 구간으로 표시합니다.",
  },
] as const;
...
export const workChildIncentiveFaqs: WorkChildIncentiveFaq[] = [
  ...
  },
  {
    ...
    answer:
      "기한 후 신청을 선택하면 예상 산정액에 95%를 반영합니다. 실제 적용 여부와 세부 금액은 심사 과정에서 달라질 수 있습니다.",
  },
  {
...
export const workChildIncentiveSources: WorkChildIncentiveSource[] = [
  {
    organization: "국세청",
    title: "근로장려금 소개",
    criterion: "가구 유형별 근로장려금 총소득 기준과 최대 지급액",
    href: "https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?cntntsId=7781&mi=2450",
  },
  {
    organization: "국세청",
    title: "2026년 신청 근로장려금·자녀장려금 제도안내",
    criterion: "2026년 신청 기준 소득·재산·자녀장려금 안내",
    href: "https://www.nts.go.kr/comm/nttFileDownload.do?fileKey=d34a9e193ae530bc8a7c671c12033b18",
  },
  {
