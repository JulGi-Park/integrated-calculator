...
export const severanceFaqs: SeveranceFaq[] = [
  ...
  {
    question: "통상임금으로 퇴직금을 계산할 때 어떤 금액을 입력하나요?",
    answer:
      "퇴직일 기준 1일 통상임금을 알고 있을 때만 입력합니다. 계산기는 입력한 1일 통상임금과 퇴직 전 임금으로 산출한 1일 평균임금을 비교해 더 큰 금액을 퇴직금 산식에 적용합니다. 통상임금에 포함되는 수당은 지급 조건과 임금 체계에 따라 달라질 수 있으므로 회사 자료나 전문가 확인이 필요합니다.",
  },
  {
