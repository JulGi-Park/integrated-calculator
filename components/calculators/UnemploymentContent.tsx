    ...
    <div className={styles.content}>
      <section className={styles.section} aria-labelledby="direct-answer-title">
        <div className={styles.sectionHeading}>
          ...
          <p>
            금액은 1일 평균임금, 선택한 소정근로시간별 상한액·하한액과 소정급여일수로 예상합니다.
      ...
      <section className={styles.section} aria-labelledby="formula-title">
        <div className={styles.sectionHeading}>
          ...
          <p>
            ...
            다음 60%를 적용한 뒤, 선택한 1일 소정근로시간의 하한액과 상한액
            범위 안에서 1일 예상 금액을 표시합니다.
          </p>
        </div>
        <dl className={styles.criteriaList}>
          ...
          <div>
          <dt>시간별 하한액·상한액 적용 방식</dt>
          <dd>
              계산 전 기준 급여액이 선택한 소정근로시간의 하한액보다 낮으면
              해당 하한액을, 상한액보다 높으면 상한액을 1일 구직급여액으로
              표시합니다.
          </dd>
          </div>
          <div>
