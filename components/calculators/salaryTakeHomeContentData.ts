...
export const salaryTakeHomeFaqs: SalaryTakeHomeFaq[] = [
  ...
  },
  {
    ...
    answer:
      "이 입력란은 월 비과세액을 받습니다. 매월 급여에 실제 포함되어 과세 대상에서 제외되는 금액을 급여명세서나 근로계약서에서 확인해 입력하세요. 식대·차량보조금 등 모든 수당이 자동으로 비과세가 되는 것은 아닙니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "기준소득월액은 모든 공제 항목에 똑같이 적용되는 하나의 금액이 아닙니다. 국민연금의 기준소득월액과 건강보험의 보수월액은 산정 방식이 다르고, 비과세 급여·상하한액·회사 신고 시점에 따라 계약상 월급과 달라질 수 있습니다. 이 계산기는 입력값을 바탕으로 한 예상치이므로 급여명세서와 차이가 크면 회사의 신고 기준과 과세·비과세 항목을 확인해 주세요.",
  },
  {
