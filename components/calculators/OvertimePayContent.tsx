...
export const overtimePayFaqs = [
  {
    question: "야간수당은 몇 시부터 계산하나요?",
    answer:
      "야간근로는 오후 10시부터 다음 날 오전 6시 사이의 근로입니다. 이 계산기에서는 해당 시간의 통상시급 50% 가산분을 야간근로 항목으로 계산합니다.",
  },
  {
    question: "연장근로수당은 어떻게 계산하나요?",
    answer:
      "연장근로로 판정된 시간은 통상시급에 1.5배를 곱해 계산합니다. 예를 들어 통상시급이 10,000원이고 연장근로가 2시간이면 해당 지급분은 30,000원입니다.",
  },
  {
    question: "휴일근로가 8시간을 넘으면 어떻게 계산하나요?",
    answer:
      "휴일근로는 8시간 이내분과 초과분을 나누어 입력합니다. 이 계산기는 이내분을 통상시급의 1.5배, 초과분을 2.0배로 계산합니다.",
  },
  {
    question: "연장근로·휴일근로와 야간근로가 겹치면 어떻게 입력하나요?",
    answer:
      "야간 시간은 추가 가산 시간이므로 연장근로 또는 휴일근로와 겹친 시간만큼 야간근로에도 함께 입력합니다. 예를 들어 연장근로 2시간이 모두 야간이면 연장 2시간과 야간 2시간을 각각 입력합니다. 휴일근로 시간은 연장근로 항목에 다시 입력하지 않습니다.",
  },
  {
    question: "5인 미만 사업장도 같은 방식으로 계산되나요?",
    answer:
      "아니요. 근로기준법 제56조의 연장·야간·휴일근로 가산 규정은 상시근로자 5인 이상 사업장에 적용됩니다. 5인 미만 사업장에서도 실제 근로한 시간의 기본임금은 지급되어야 하며, 가산수당 약정이 있는지는 근로계약서나 취업규칙을 확인해야 합니다.",
  },
  {
    question: "통상시급에는 무엇을 입력하나요?",
    answer:
      "연장·야간·휴일근로수당 계산에 사용하는 시간당 통상임금을 입력합니다. 월급제인지 시급제인지, 고정적으로 지급되는 임금 항목이 무엇인지에 따라 산정이 달라질 수 있으므로 급여명세서와 근로계약서를 함께 확인하세요.",
  },
  {
...
const criteria = [
  ["기준일", "2026년 8월 9일 기준으로 근로기준법 제56조의 연장·야간 및 휴일근로 가산 기준을 참고합니다."],
  ["적용 사업장", "이 계산기는 상시근로자 5인 이상 사업장의 법정 가산 기준을 전제로 합니다. 5인 미만 사업장은 근로계약·취업규칙에 따른 지급 기준을 확인해야 합니다."],
...
const examples = [
  ...
  ["시급 10,000원, 휴일근로 2시간과 야간 2시간", "휴일근로 30,000원 + 야간가산 10,000원 = 40,000원"],
] as const;
...
const cautions = [
  ...
  "상시근로자 5인 미만 사업장에는 근로기준법 제56조의 법정 가산 규정이 적용되지 않으며, 별도 약정이 있는지는 확인이 필요합니다.",
    ...
    <div className={styles.content}>
      <section className={styles.section} aria-labelledby="overtime-criteria">
        <div className={styles.sectionHeading}>
          ...
          <p>
            상시근로자 5인 이상 사업장의 근로기준법 제56조 기준을 참고해 입력한
            시간별 예상 지급분과 법정 가산분을 분리 계산합니다.
          </p>
        </div>
      ...
      <section className={styles.section} aria-labelledby="overtime-sources">
        <div className={styles.sectionHeading}>
          ...
          <p>2026년 8월 9일 기준 근로기준법 제56조를 참고했습니다.</p>
        </div>
