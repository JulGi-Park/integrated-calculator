            ...
            <div aria-live="polite">
              ...
              <div className={styles.detailSection}>
                ...
                <dl className={styles.detailGrid}>
                  ...
                  <div>
                    <dt>근로장려금 감액 전 예상액</dt>
                    <dd><ResultAmount value={result.work.estimatedBeforeReduction} /></dd>
                  </div>
                  <div>
                    <dt>자녀장려금 예상액</dt>
                  ...
                  <div>
                    <dt>자녀장려금 감액 전 예상액</dt>
                    <dd><ResultAmount value={result.child.estimatedBeforeReduction} /></dd>
                  </div>
                </dl>
              </div>
