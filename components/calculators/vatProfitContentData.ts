...
export const vatProfitFaqs = [
  ...
  {
    question: "부가세 포함 금액에서 부가세는 어떻게 계산하나요?",
    answer:
      "부가세 포함 합계금액을 1.1로 나누면 공급가액을 역산할 수 있고, 합계금액에서 공급가액을 빼면 포함된 부가세가 계산됩니다. 이 계산은 일반과세자 기본 세율 10%를 전제로 합니다.",
  },
  {
    question: "매출세액과 예상 납부세액은 어떻게 다른가요?",
    answer:
      "매출세액은 판매에 붙은 부가세이고, 예상 납부세액은 매출세액에서 입력한 매입세액을 뺀 계산값입니다. 실제 신고에서는 공제 요건과 불공제 항목을 확인해야 합니다.",
  },
  {
    question: "세액 계산을 위해 공급가액과 합계금액 중 무엇을 입력하나요?",
    answer:
      "부가세를 제외한 금액을 알고 있으면 공급가액을, 부가세가 포함된 결제금액을 알고 있으면 합계금액을 선택해 입력합니다. 합계금액을 입력하면 일반과세자 기본 세율 10%를 전제로 공급가액과 포함된 부가세를 역산합니다.",
  },
] as const;
