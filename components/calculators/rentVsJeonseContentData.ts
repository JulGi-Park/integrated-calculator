...
export const rentVsJeonseFaqs: RentVsJeonseFaq[] = [
  ...
  {
    question: "전세대출금리는 어떤 값을 입력하나요?",
    answer:
      "전세대출을 이용할 때 적용받을 것으로 예상하는 연 이율을 입력합니다. 금융기관의 실제 금리는 상품, 우대조건, 대출 시점과 개인 조건에 따라 달라질 수 있으므로 최신 대출 안내에서 확인한 금리를 입력하고, 계산 결과는 금리 변동을 반영한 비교용 참고값으로 보세요.",
  },
  {
